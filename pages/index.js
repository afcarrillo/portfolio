...
import { ipadPic } from "../public/img/ipad.png";
import { bgHeadPic } from "../public/img/bg-masthead.jpg";
import { demo1Pic } from "../public/img/demo-image-01.jpg";
import { demo2Pic } from "../public/img/demo-image-02.jpg";
      ...
      <main>
        ...
        <section class="about-section text-center" id="about">
          <div class="container px-4 px-lg-5">
            ...
            <Image class="img-fluid" src={ipadPic} alt="..." />
          </div>
        </section>
        {/* <!-- Projects--> */}
        <section class="projects-section bg-light" id="projects">
          <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
              <div class="col-lg-6">
                <Image class="img-fluid" src={demo1Pic} alt="demoPic1" />
              </div>
              <div class="col-lg-6">
            ...
            <div class="row gx-0 justify-content-center">
              <div class="col-lg-6">
                <Image class="img-fluid" src={demo2Pic} alt="demoPic2" />
              </div>
